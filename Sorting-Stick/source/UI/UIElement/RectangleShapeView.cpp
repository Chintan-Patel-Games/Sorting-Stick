...
namespace UI
{
	namespace UIElement
	{
		...
		void RectangleShapeView::setPosition(sf::Vector2f rectangle_position) { rectangle_shape.setPosition(getPositionForCurrentResolution(rectangle_position)); }
		...
		sf::Vector2f RectangleShapeView::getSize() const { return rectangle_shape.getSize(); }
	}
}