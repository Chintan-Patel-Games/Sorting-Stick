...
namespace UI
{
    namespace UIElement
    {
        ...
        void ImageView::setTexture(sf::String texture_path) { if (image_texture.loadFromFile(texture_path)) image_sprite.setTexture(image_texture); }
        ...
        void ImageView::setOriginAtCentre() { image_sprite.setOrigin(image_sprite.getLocalBounds().width / 2, image_sprite.getLocalBounds().height / 2); }
