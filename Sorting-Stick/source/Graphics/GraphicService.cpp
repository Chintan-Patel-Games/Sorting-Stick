...
namespace Graphics
{
	...
	void GraphicService::configureVideoMode() { video_mode = *(new sf::VideoMode(game_window_width, game_window_height, sf::VideoMode::getDesktopMode().bitsPerPixel)); }

	void GraphicService::setReferenceResolution() { reference_resolution = sf::Vector2f(game_window_width, game_window_height); }
